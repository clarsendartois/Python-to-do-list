...
# Heading Label
Label(root, text="Tech Vidvan To-Do List", bg="PaleVioletRed",
...
add_bth = Button(root, text="Add Item", bg="Azure", width=10, font=(
    "Helvetica, 12"), command=lambda: add_item(new_item_entry, tasks))
add_bth.place(x=45, y=350)

delete_btn = Button(root, text="Delete Item", bg="Azure", width=10, font=(
    "Helvetica", 12), command=lambda: delete_item(tasks))
